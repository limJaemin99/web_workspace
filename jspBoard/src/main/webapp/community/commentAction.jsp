...
<body>
<% 
	//필요한 파라미터 가져오기 (communityComments.xml 참고)
		//▶ mref , writer , content , f(insert 또는 delete) , page
	...
	communityCommentsDAO dao = communityCommentsDAO.getCommunityCommentsDAO();
	...
	} else if (f.equals("2")) {	//댓글 삭제 완료
		int idx = Integer.parseInt(request.getParameter("idx"));	//댓글의 idx 값 가져오기
		dao.delete(idx);
		dao.setCommentCount(mref);	//댓글 갯수 새로 구하기
